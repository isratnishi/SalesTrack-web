...
<head>
    ...
    <title>Sales Track Admin - Dashboard</title>
...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="{{URL::to('/')}}">Sales Track</a>
...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="sidebar navbar-nav" style="background-color: #661c92 !important;">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{URL::to('/addRegion')}}">
                <i class="fas fa-plus-circle"></i>
                <span> Add Region </span>
            </a>
        </li>
        <li class="nav-item active">
            <a class="nav-link" href="{{URL::to('/addSite')}}">
                <i class="fas fa-plus-circle"></i>
                <span> Add Site </span>
            </a>
        </li>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{URL::to('/addVisitSite')}}">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{URL::to('/heirarchy')}}">
                <i class="fas fa-cart-plus"></i>
                <span> Tree  </span>
            </a>
        </li>
